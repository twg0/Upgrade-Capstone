...
public class DeviceController {
	...
	public ResponseEntity<DeviceResponse> registerUser(
		@Validated @RequestBody DeviceRegisterUserRequest deviceRegisterUserRequest,
		@PathVariable Long id) {
		return ResponseEntity.ok(deviceService.registerUser(id, deviceRegisterUserRequest));
	}

	@PostMapping("/{id}/villages")
	public ResponseEntity<DeviceResponse> registerVillage(
		@Validated @RequestBody DeviceRegisterVillageRequest deviceRegisterVillageRequest,
		@PathVariable Long id) {
